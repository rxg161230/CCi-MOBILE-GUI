...
MAP.Left.Nmaxima            = 1;            % Nmaxima 1 - 22 for n-of-m strategies
...
MAP.Right.Nmaxima           = 1;                % Nmaxima 1 - 22 for n-of-m strategies
MAP.Right.StimulationMode   = 'MP1+2';          % Electrode Configuration/Stimulation mode e.g., MP1, MP1+2, BP1, BP1+2, CG,....etc.
MAP.Right.StimulationRate   = 125;             % Stimulation rate per electrode in number of pulses per second (pps)
