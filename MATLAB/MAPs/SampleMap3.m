...
MAP.Left.StimulationRate    = 1500;         % Stimulation rate per electrode in number of pulses per second (pps)
...
MAP.Right.StimulationRate   = 700;             % Stimulation rate per electrode in number of pulses per second (pps)
