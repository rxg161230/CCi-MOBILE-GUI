...
%           Copyright Cochlear Ltd - derived from Nucleus MATLAB Toolboxv2*
%
% This function calls:
...
%     sineL = im2double (sine_token_l);
%     signalL = delayseq(sineL,1);
    indL = 1;
...
%                         % stim.l(j)= sineL(indL);
%                         % stim.l(j)= signalL(indL);
%                          
%                          indL=indL+1;
%                          if indL==length(sine_token_l)+1
%                         % if indL==length(sineL)+1
%                         % if indL==length(signalL)+1
%                              indL=1;
%                          end
%                      end
%          
