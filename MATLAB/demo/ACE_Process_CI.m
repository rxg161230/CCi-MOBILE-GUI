...
function [stimulus] = ACE_Process_CI(audio, bufferHistory, p)
global fs;fs=sampling_fre; % 16000 Hz
...
%cd 'C:\Users\nxm175730\Documents\Mamun\LAB\Program Matlab\Speaker Identification\Program\Class Project\CommonFunctions'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %% Plot Electrodogram generation and plot
 % [electrodogramMatrix] = getElectrodogramMatrix(stimulus.electrodes,stimulus.current_levels);
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% q.electrodes(q_is_idle) = 0;
